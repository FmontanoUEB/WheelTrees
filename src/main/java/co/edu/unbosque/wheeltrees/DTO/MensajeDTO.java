...
public class MensajeDTO {
	...
	public static class EnviarMensajeRequest {
		// Sin @NotNull: en el endpoint REST este campo llega null en el body
		// (se completa después, desde la URL) y @Valid se ejecuta ANTES de
		// que el controlador lo complete. Por WebSocket sí viaja siempre.
