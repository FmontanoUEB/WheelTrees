...
public class Usuario implements UserDetails {
    ...
    // Denormalizado a propósito (se recalcula en CalificacionService cada
    // vez que se guarda una calificación nueva) para no tener que agregar
    // sobre la tabla calificaciones cada vez que se muestra un perfil.
    ...
    public boolean isEnabled() {
        return cuentaActiva && emailVerificado;
    }
}