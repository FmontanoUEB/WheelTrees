...
import co.edu.unbosque.wheeltrees.DTO.AuthDTO.SolicitarRecuperacionRequest;
...
public class AuthController {
	...
	public ResponseEntity<MensajeResponse> solicitarRecuperacion(
		...
		return ResponseEntity.ok(authService.solicitarRecuperacionPassword(request.getEmail()));
	}
	...
	public ResponseEntity<MensajeResponse> verificarCodigoRecuperacion(
			@Valid @RequestBody ValidarCodigoRecuperacionRequest request) {
